...
const Input = ({ placeholder, name, type, value, handlechange }) => (
  <input
    ...
    className="my-2 w-full rounded-sm p-2 outine-none bg-transparent text-white white-glassmorphism "
  />
);
const commanStyles =
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4  ">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10 ">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={` rounded-tr-2xl ${commanStyles}`}>Ethereum </div>
            <div className={` rounded-bl-2xl ${commanStyles}`}>Web 3.0 </div>
